...
def compile_track(music_ml_model, music_ml_meta, track, midi_file, track_number):
    ...
    for bar in track.bars:
        compile_bar(music_ml_model, music_ml_meta, bar, midi_file, track, track_number, channel)


def compile_bar(music_ml_model, music_ml_meta, bar, midi_file, track, track_number, channel):
...
def compile_note_event(music_ml_model, music_ml_meta, note, position, midi_file, track_number, channel):
...
def compile_simple_note_event(music_ml_model, note, position, midi_file, track_number, channel, ticks_to_add=0):
    ...
    midi_file.addNote(track_number, channel, value, position_in_ticks, duration, 100)
